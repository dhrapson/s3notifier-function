...
public class EmailManagerIT {
    ...
    public void testS3BucketHandler() throws Exception {
        ...
        EmailManager manager = new EmailManager("email-smtp.eu-west-1.amazonaws.com", 25, System.getenv(EnvVars.SMTP_USERNAME_ENV_VAR), System.getenv(EnvVars.SMTP_PASSWORD_ENV_VAR),
                System.getenv(EnvVars.EMAIL_FROM_ENV_VAR));
